...
from pubnub.endpoints.channel_groups.add_channel_to_channel_group import (
...
class TestAddChannelToChannelGroup(unittest.TestCase):
    ...
    def test_add_single_channel(self):
        ...
        self.assertEqual(
            self.add.build_params_callback()({}),
            {"pnsdk": sdk_name, "uuid": self.pubnub.uuid, "add": "ch"},
        )
    ...
    def test_add_multiple_channels(self):
        ...
        self.assertEqual(
            self.add.build_params_callback()({}),
            {"pnsdk": sdk_name, "uuid": self.pubnub.uuid, "add": "ch1,ch2"},
        )
