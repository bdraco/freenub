...
from pubnub.endpoints.channel_groups.list_channels_in_channel_group import (
...
class TestListChannelsInChannelGroup(unittest.TestCase):
    ...
    def test_list_channel_group(self):
        ...
        self.assertEqual(
            ...
            ListChannelsInChannelGroup.LIST_PATH % (pnconf.subscribe_key, "gr"),
        )

        self.assertEqual(
            self.list.build_params_callback()({}),
            {
                "pnsdk": sdk_name,
