...
class TestSetState(unittest.TestCase):
    ...
    def test_set_state_single_channel(self):
        ...
        self.assertEqual(
            self.set_state.build_path(),
            SetState.SET_STATE_PATH % (pnconf.subscribe_key, "ch", self.pubnub.uuid),
        )
    ...
    def test_set_state_single_group(self):
        ...
        self.assertEqual(
            self.set_state.build_path(),
            SetState.SET_STATE_PATH % (pnconf.subscribe_key, ",", self.pubnub.uuid),
        )
