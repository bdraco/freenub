...
@get_sleeper(
    "tests/integrational/fixtures/asyncio/groups/add_remove_single_channel.yaml"
)
@pn_vcr.use_cassette(
    "tests/integrational/fixtures/asyncio/groups/add_remove_single_channel.yaml",
...
@get_sleeper(
    "tests/integrational/fixtures/asyncio/groups/add_remove_multiple_channels.yaml"
)
@pn_vcr.use_cassette(
    "tests/integrational/fixtures/asyncio/groups/add_remove_multiple_channels.yaml",
    filter_query_parameters=["uuid", "pnsdk", "l_cg", "l_pub"],
...
@get_sleeper(
    "tests/integrational/fixtures/asyncio/groups/add_channel_remove_group.yaml"
)
@pn_vcr.use_cassette(
    "tests/integrational/fixtures/asyncio/groups/add_channel_remove_group.yaml",
    filter_query_parameters=["uuid", "pnsdk", "l_cg", "l_pub"],
