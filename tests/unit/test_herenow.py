...
single_with_state = {
    ...
    "uuids": [
        {
            "state": {"count": 5, "name": "Alex"},
            "uuid": "6cbb18b9-3f58-4bd3-91c0-5dbf18a4af13",
        }
    ],
}
...
multiple = {
    ...
    "payload": {
        ...
        "channels": {
            "here-now-GIY92DGX": {
                "occupancy": 1,
                "uuids": ["c71b2961-9624-4801-90bc-6c89a725a422"],
            },
            "here-now-B1WZA4LO": {
                "occupancy": 1,
                "uuids": ["c71b2961-9624-4801-90bc-6c89a725a422"],
...
multiple_disable_uuids = {
    "payload": {
        "channels": {
            "here-now-IUX5HV7O": {"occupancy": 1},
            "here-now-FGE5Q9UY": {"occupancy": 1},
        },
        "total_occupancy": 2,
        "total_channels": 2,
    },
        ...
        "channels": {
            "here-now-UBJJ5P3W": {
                "uuids": [
                    {
                        "state": {"count": 5, "name": "Alex"},
                        "uuid": "abf41ee8-0853-4e1c-8450-906933695b09",
                    }
                ],
                "occupancy": 1,
            },
            "here-now-EZTFTHZY": {
                "uuids": [{"uuid": "abf41ee8-0853-4e1c-8450-906933695b09"}],
                "occupancy": 1,
            },
        },
        "total_occupancy": 2,
...
class TestHereNowResultGenerator(unittest.TestCase):
    ...
    def test_multiple(self):
        ...
        assert (
            channel1.occupancy
            == multiple["payload"]["channels"][channel_names[0]]["occupancy"]
        )
        ...
        assert (
            occupants.uuid
            == multiple["payload"]["channels"][channel_names[0]]["uuids"][0]
        )
        ...
        assert (
            channel2.occupancy
            == multiple["payload"]["channels"][channel_names[1]]["occupancy"]
        )
        ...
        assert (
            occupants.uuid
            == multiple["payload"]["channels"][channel_names[1]]["uuids"][0]
        )
    ...
    def test_multiple_disable_uuids(self):
        ...
        assert (
            channel1.occupancy
            == multiple_disable_uuids["payload"]["channels"][channel_names[0]][
                "occupancy"
            ]
        )
        ...
        assert (
            channel2.occupancy
            == multiple_disable_uuids["payload"]["channels"][channel_names[1]][
                "occupancy"
            ]
        )
    ...
    def test_multiple_with_state(self):
        channel_names = list(
            reversed(sorted(list(multiple_with_state["payload"]["channels"])))
        )
        ...
        assert (
            channel1.occupancy
            == multiple_with_state["payload"]["channels"][channel1.channel_name][
                "occupancy"
            ]
        )
        assert len(channel1.occupants) == 1
        ...
        assert (
            channel2.occupancy
            == multiple_with_state["payload"]["channels"][channel2.channel_name][
                "occupancy"
            ]
        )
        assert len(channel2.occupants) == 1
