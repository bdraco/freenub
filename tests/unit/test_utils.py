...
class TestBuildUrl(unittest.TestCase):
    def test_build_url(self):
        ...
        match(
            "http://ex.com/news?a=2&b=qwer",
            build_url("http", "ex.com", "/news", "a=2&b=qwer"),
        )
        match(
            "https://ex.com/?a=2&b=qwer",
...
class TestPreparePAMArguments(unittest.TestCase):
    def test_prepare_pam_arguments(self):
        params = {"abc": True, "poq": 4, "def": False}
...
grant
channel=asyncio-pam-FI2FCS0A&pnsdk=PubNub-Python-Asyncio%252F4.0.4&r=1&timestamp=1468409553&uuid=a4dbf92e-e5cb-428f-b6e6-35cce03500a2&w=1"""
